...
unsigned char *attack_4p_data[6] = {&attack_2p_3_spr[0], &attack_2p_3_spr[0], &attack_2p_4_spr[0], &attack_2p_4_spr[0], &attack_2p_4_spr[0], &attack_2p_5_spr[0]};
unsigned char *hit_2p_data[2] = {&hit_2p_1_spr[0], &hit_2p_2_spr[0]};
unsigned char *hit_4p_data[2] = {&hit_4p_1_spr[0], &hit_4p_2_spr[0]};
